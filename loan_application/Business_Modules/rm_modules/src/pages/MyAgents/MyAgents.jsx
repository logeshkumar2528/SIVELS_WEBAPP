    ...
    { 
      ...
      render: (row) => (
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <img src={row.profileImagePath ? `https://fusiontecsoftware.com/sivels${row.profileImagePath}` : 'https://via.placeholder.com/32'} alt={row.fullName} style={{ width: '32px', height: '32px', borderRadius: '50%', objectFit: 'cover' }} />
        ...
        {selectedAgent && (
          <div className="agent-details-modal">
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
              <img src={selectedAgent.profileImagePath ? `https://fusiontecsoftware.com/sivels${selectedAgent.profileImagePath}` : 'https://via.placeholder.com/64'} alt={selectedAgent.fullName} style={{ width: '64px', height: '64px', borderRadius: '50%', objectFit: 'cover' }} />
              <div>
