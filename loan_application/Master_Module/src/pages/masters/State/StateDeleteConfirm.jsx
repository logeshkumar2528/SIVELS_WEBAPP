...
import { deleteState } from '../../../api/masters/stateApi';
import { getErrorMessage } from '../../../utils/errorHelper';

export function StateDeleteConfirm({ isOpen, onClose, onSuccess, record }) {
  ...
  const handleDelete = async () => {
    if (!record || !record.stateId) {
      console.error('Missing stateId for deletion');
      return;
    }

    setIsDeleting(true);
    try {
      const response = await deleteState(record.stateId);
