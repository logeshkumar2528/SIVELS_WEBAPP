        ...
        <div className="dashboard-card">
          ...
          <div className="inner-border-wrapper loan-summary-wrapper">
            <div className="loan-summary-grid">
              <div className="summary-item"><span className="summary-label">Loan Amount</span><span className="summary-value">{loanAmount}</span></div>
          ...
          <Link to={ROUTES.MY_LOAN} className="btn-outline-primary">
