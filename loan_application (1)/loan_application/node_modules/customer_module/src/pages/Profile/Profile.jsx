...
const sections = [
  { title: 'Personal Information', icon: CircleUserRound, values: [['First Name', 'Arjun'], ['Last Name', 'Kumar'], ['Date of Birth', '15 Aug 1990'], ['Gender', 'Male'], ['Marital Status', 'Married']] },
  { title: 'Contact Information', icon: Phone, values: [['Mobile Number', '+91 98765 43210', true], ['Email Address', 'arjunkumar@email.com', true]] },
  { title: 'Address Information', icon: MapPin, address: true },
  { title: 'Employment Information', icon: BriefcaseBusiness, values: [['Employer Name', 'TCS Private Limited'], ['Designation', 'Software Engineer'], ['Monthly Salary', '₹85,000']] },
...
export default function Profile() {
  return <div className="profile-page">
    ...
    <section className="profile-summary"><div className="profile-avatar"><CircleUserRound size={43} /></div><div className="profile-summary-text"><div><h2>Arjun Kumar</h2><span>Verified Customer</span></div><p>Customer ID: <b>CUS2025001234</b></p><p>Member since: <b>15 May 2025</b></p></div><div className="profile-completion"><div><b>Profile Completion</b><strong>100%</strong></div><span><i /></span><p><Check size={17} /> Your profile is complete</p></div></section>
