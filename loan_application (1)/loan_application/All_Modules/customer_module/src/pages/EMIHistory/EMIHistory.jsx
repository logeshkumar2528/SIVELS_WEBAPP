...
export default function EMIHistory() {
  ...
  return <div className="emi-history-page">
    ...
    <section className="emi-loan-banner"><div className="emi-loan-id"><span className="emi-building"><Building2 size={25} /></span><div><small>Loan ID</small><strong>LN2025001234</strong><b>Personal Loan</b></div><span className="emi-active-badge">Active</span></div><div className="emi-loan-metrics"><BannerMetric label="Loan Amount" value="₹2,00,000" /><BannerMetric label="EMI Amount" value="₹4,980" /><BannerMetric label="Tenure" value="36 Months" /><BannerMetric label="EMI Paid" value="18" /><BannerMetric label="EMI Remaining" value="18" /></div></section>
