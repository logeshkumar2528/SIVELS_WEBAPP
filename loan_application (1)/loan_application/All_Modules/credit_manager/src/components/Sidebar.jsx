    ...
    <aside className="sidebar" aria-label="Main navigation">
      ...
      <div className="sidebar-logo" aria-label="Sivels Finance home">
        <div className="sidebar-logo-img">
          <svg width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="#113f28" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2v20M8 22h8M10 10h4M10 14h4M9 18h6M12 2a2 2 0 0 1 2 2v2h-4V4a2 2 0 0 1 2-2z"/>
            <path d="M4 12l2-2M20 12l-2-2M6 8l1-1M18 8l-1-1"/>
          </svg>
        </div>
