        ...
        <div className="aw-grid">
          ...
          <div className="aw-field">
            ...
            <div className="aw-input-wrapper">
              <Map className="aw-input-icon" size={14} />
              <select
                className={`form-select aw-input aw-input--with-icon ${errors.state ? 'aw-input--invalid' : ''}`}
                value={address.state}
          ...
          <div className="aw-field">
            ...
            <div className="aw-input-wrapper">
              <HelpCircle className="aw-input-icon" size={14} />
              <select
                className="form-select aw-input aw-input--with-icon"
                value={address.mailingSameAsCurrent}
                onChange={(e) => onChange('mailingSameAsCurrent', e.target.value)}
              >
