    ...
    <div className="cr-person-card">
      <div className="cr-person-card__header">
        <div>
          ...
          <div className="cr-person-card__subtitle">
            {relationshipMode === 'readOnly' ? 'Applicant information' : 'Co-applicant information'}
          </div>
        </div>
        ...
        <div className="cr-form-grid">
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              ...
              {relationshipMode === 'select' ? (
                <select
                  className={`form-select cr-input cr-input--with-icon ${errors.relationshipWithApplicant ? 'cr-input--invalid' : ''}`}
                  value={person.relationshipWithApplicant}
                  onChange={(event) => handleChange('relationshipWithApplicant', event.target.value)}
                >
          ...
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              ...
              <select
                className={`form-select cr-input cr-input--with-icon ${errors.title ? 'cr-input--invalid' : ''}`}
                value={person.title}
          ...
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              <Calendar className="cr-input-icon" size={14} />
              <input
                className={`form-input cr-input cr-input--with-icon ${errors.dateOfBirth ? 'cr-input--invalid' : ''}`}
                type="date"
            ...
            <span className="cr-field-help">DD/MM/YYYY</span>
          ...
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              <FileText className="cr-input-icon" size={14} />
              <select
                className="form-select cr-input cr-input--with-icon"
          ...
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              <User className="cr-input-icon" size={14} />
              <select
                className={`form-select cr-input cr-input--with-icon ${errors.gender ? 'cr-input--invalid' : ''}`}
                value={person.gender}
          ...
          <div className="cr-field">
            ...
            <div className="cr-input-wrapper">
              <UserCheck className="cr-input-icon" size={14} />
              <select
                className={`form-select cr-input cr-input--with-icon ${errors.maritalStatus ? 'cr-input--invalid' : ''}`}
  ...
  return (
    <div className="page-container cr-page-root compact-mode">
      ...
      <div className="panel cr-form-card">
        <div className="cr-form-header-compact" style={{ padding: '0 0 12px 0', display: 'flex', justifyContent: 'flex-end' }}>
          <div className="cr-form-chip">Draft saved automatically</div>
        </div>
        ...
        <div className="cr-form-footer">
          <div className="cr-footer-note">
            {InfoIcon && <InfoIcon size={13} />}
            <span>Section 2 data is saved with the same application ID and retained when you come back.</span>
          </div>
